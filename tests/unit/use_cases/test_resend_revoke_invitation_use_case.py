...
@pytest.mark.asyncio
async def test_successful_resend_invitation(mock_uow, mock_audit_service):
    ...
    # Act
    use_case = ResendInvitationUseCase(mock_uow, mock_audit_service)
...
@pytest.mark.asyncio
async def test_resend_invitation_insufficient_role(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_resend_invitation_already_accepted(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_resend_invitation_not_found(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_resend_invitation_wrong_tenant(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_successful_revoke_invitation(mock_uow, mock_audit_service):
    ...
    # Act
    use_case = RevokeInvitationUseCase(mock_uow, mock_audit_service)
    result = await use_case.execute(user_id, tenant_id, invitation_id)
...
@pytest.mark.asyncio
async def test_revoke_invitation_insufficient_role(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_revoke_invitation_already_accepted(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_revoke_invitation_not_found(mock_uow, mock_audit_service):
