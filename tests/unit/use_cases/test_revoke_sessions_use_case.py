...
@pytest.mark.asyncio
async def test_revoke_all_sessions_self_success(mock_uow, mock_audit_service):
    ...
    use_case = RevokeSessionsUseCase(mock_uow, mock_audit_service)
...
@pytest.mark.asyncio
async def test_revoke_all_sessions_admin_success(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_revoke_all_sessions_forbidden(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_revoke_all_sessions_user_not_found(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_revoke_specific_session_self_success(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_revoke_specific_session_not_found(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_revoke_specific_session_already_revoked(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_revoke_specific_session_forbidden(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_revoke_all_except_current_success(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_revoke_all_except_current_session_not_found(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_revoke_all_except_current_forbidden(mock_uow, mock_audit_service):
