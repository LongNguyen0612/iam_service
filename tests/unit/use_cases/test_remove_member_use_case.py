...
@pytest.mark.asyncio
async def test_successful_member_removal_by_owner(mock_uow, mock_audit_service):
    ...
    # Act
    use_case = RemoveMemberUseCase(mock_uow, mock_audit_service)
...
@pytest.mark.asyncio
async def test_successful_member_removal_by_admin(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_owner_removes_self_with_multiple_owners(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_cannot_remove_last_owner(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_admin_cannot_remove_owner(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_member_cannot_remove_anyone(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_membership_not_found(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_requester_not_a_member(mock_uow, mock_audit_service):
