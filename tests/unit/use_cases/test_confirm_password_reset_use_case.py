...
@pytest.mark.asyncio
async def test_successful_password_reset_confirmation(mock_uow, mock_audit_service):
    ...
    use_case = ConfirmPasswordResetUseCase(mock_uow, mock_audit_service)
...
@pytest.mark.asyncio
async def test_expired_token(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_already_used_token(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_all_sessions_revoked(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_token_marked_as_used(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_audit_event_created(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_user_not_found(mock_uow, mock_audit_service):
