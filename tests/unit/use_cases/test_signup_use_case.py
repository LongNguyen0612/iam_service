...
@pytest.mark.asyncio
async def test_successful_signup(mock_uow, mock_audit_service):
    ...
    use_case = SignupUseCase(mock_uow, mock_audit_service)
...
@pytest.mark.asyncio
async def test_signup_email_already_exists(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_password_hashing(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_transaction_commit_called(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_membership_created_with_owner_role(mock_uow, mock_audit_service):
