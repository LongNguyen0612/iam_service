...
@pytest.mark.asyncio
async def test_successful_acceptance_existing_user(mock_uow, mock_audit_service):
    ...
    # Act
    use_case = AcceptInvitationUseCase(mock_uow, mock_audit_service)
...
@pytest.mark.asyncio
async def test_successful_acceptance_new_user(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_expired_invitation(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_already_accepted_invitation(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_invalid_token(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_password_required_for_new_user(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_password_too_short(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_tenant_not_found(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_password_is_hashed_with_bcrypt(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_session_created_with_refresh_token(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_audit_event_created_with_metadata(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_last_active_tenant_updated(mock_uow, mock_audit_service):
