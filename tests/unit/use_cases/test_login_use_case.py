...
@pytest.mark.asyncio
async def test_successful_login(mock_uow, mock_audit_service):
    ...
    use_case = LoginUseCase(mock_uow, mock_audit_service)
...
@pytest.mark.asyncio
async def test_login_invalid_credentials_wrong_password(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_login_invalid_credentials_nonexistent_user(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_login_user_disabled(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_login_no_active_membership(mock_uow, mock_audit_service):
...
@pytest.mark.asyncio
async def test_login_default_tenant_selection(mock_uow, mock_audit_service):
