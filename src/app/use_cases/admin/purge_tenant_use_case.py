...
class PurgeTenantUseCase:
    ...
    async def execute(self, tenant_id: UUID) -> Result[PurgeTenantResponse]:
        ...
        async with self.uow:
            ...
            deleted_at_iso = tenant.deleted_at.isoformat()
            stats = {
            ...
            # 10. Note: In a full implementation, we would delete the tenant record
            ...
            # 12. Create final audit event (best effort, after commit)
