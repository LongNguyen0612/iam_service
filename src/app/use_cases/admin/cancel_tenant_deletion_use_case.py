...
class CancelTenantDeletionUseCase:
    ...
    async def execute(self, tenant_id: UUID) -> Result[CancelTenantDeletionResponse]:
        ...
        async with self.uow:
            ...
            original_deletion_date = deleted_at_aware.isoformat() if deleted_at_aware else None
            ...
            # 6. Create audit event (best effort, after commit)
            await self.audit_service.log_event(
                ...
                metadata={
                    ...
                    "original_deletion_date": original_deletion_date,
                },
            )
