...
async def signup(
    ...
    use_case = SignupUseCase(uow, audit_service)
...
async def login(
    ...
    Raises:
        ...
        - 500 Internal Server Error: Server error
    """
    use_case = LoginUseCase(uow, audit_service)
...
async def refresh(
    ...
    Raises:
        ...
        - 500 Internal Server Error: Server error
    """
    use_case = RefreshTokenUseCase(uow, audit_service)
...
async def verify_email(
    ...
    Raises:
        ...
        - 500 Internal Server Error: Server error
    """
    use_case = VerifyEmailUseCase(uow, audit_service)
...
async def request_password_reset(
    ...
    Returns:
        ...
        - 500 Internal Server Error: Server error
    """
    use_case = RequestPasswordResetUseCase(uow, audit_service)
    result = await use_case.execute(request.email)
...
async def confirm_password_reset(
    ...
    Raises:
        ...
        - 500 Internal Server Error: Server error
    """
    use_case = ConfirmPasswordResetUseCase(uow, audit_service)
