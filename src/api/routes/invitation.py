...
async def accept_invitation(
    ...
    """
    # Execute use case
    use_case = AcceptInvitationUseCase(uow, audit_service)
...
async def resend_invitation(
    ...
    # Execute use case
    use_case = ResendInvitationUseCase(uow, audit_service)
...
async def revoke_invitation(
    ...
    # Execute use case
    use_case = RevokeInvitationUseCase(uow, audit_service)
    result = await use_case.execute(user_id, tenant_id, invitation_uuid)
